...
//-bof-sortable_orders_status-lat9  *** 1 of 7 ***
        $sql_data_array['sort_order'] = (int)$_POST['sort_order'];
//-eof-sortable_orders_status-lat9  *** 1 of 7 ***
...
<?php
//-bof-sortable_orders_status-lat9  *** 2 of 7 *** (Adds status-id and sort-order headings)
?>
...
<?php
//-eof-sortable_orders_status-lat9  *** 2 of 7 ***
?>
            ...
            <tbody>
                <?php
//-bof-sortable_orders_status-lat9  *** 3 of 7 *** (Change from orders_status_id, orders_status_name to *, ORDER BY to sort_order, then status_id)
                $orders_status_query_raw = "select *
                                            from " . TABLE_ORDERS_STATUS . "
                                            where language_id = " . (int)$_SESSION['languages_id'] . "
                                            order by sort_order ASC, orders_status_id ASC";
//-eof-sortable-orders_status_lat9  *** 3 of 7 ***
...
//-bof-sortable_orders_status-lat9  *** 4 of 7 ***
                  echo '                    <td class="dataTableContent">' . $status['orders_status_id'] . '</td>';
//-eof-sortable_orders_status-lat9  *** 4 of 7 ***
...
//-bof-sortable_orders_status-lat9  *** 5 of 7 ***
                  echo '                    <td class="dataTableContent">' . $status['sort_order'] . '</td>';
//-eof-sortable_orders_status-lat9  *** 5 of 7 ***
                  ?>
